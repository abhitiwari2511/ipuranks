...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 w-full bg-transparent">
      <div className="relative mx-auto flex w-full max-w-7xl flex-nowrap items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <Link
          to="/"
          className="flex min-w-0 shrink-0 items-center gap-3 whitespace-nowrap transition-opacity hover:opacity-80"
        >
